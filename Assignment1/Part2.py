""""
Assignment 1 - Part 2
Arithmetic operations - Multiplication and Division with input validations
Author: Shadab
"""

# Python code for Multiplication and Division of numbers
...
while True:
    try:
        ...
        if number2 == 0:
            print("Division by Zero provides a Undefined value. Enter a Non-Zero value\n")
            continue
        break
...
print("\n***** Result Summary *****\n")
print("Result for Multiplication of Numbers:", addition)
print("Result for Division of Numbers:", subtraction)
